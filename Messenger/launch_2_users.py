...
while True:
    ...
    if CHOICE == 'q':
        ...
        time.sleep(0.5)
        PROCESSES.append(subprocess.Popen('gnome-terminal -- python3 client_class.py -n user1', shell=True))
        PROCESSES.append(subprocess.Popen('gnome-terminal -- python3 client_class.py -n user2', shell=True))
    elif CHOICE == 'x':
        while PROCESSES:
